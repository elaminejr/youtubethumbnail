  ...
  return (
    ...
    <div style={styles.container}>
      ...
      Using our website to download YouTube video thumbnails is a straightforward process. Simply locate the YouTube video you're interested in, copy the video's URL, and paste it into the designated area on our site. We'll process the request and provide you with a downloadable thumbnail file to save on your device. This gives you the freedom to incorporate these thumbnails into your various creative endeavors.     
       ...
       <p>
       If you have any questions, feedback, or suggestions, we welcome your input. Please feel free to reach out to us via email at relnoorain@gmail.com. We appreciate your engagement and continuously work to improve our service based on user needs.
       </p>
       <p>
       ...
       <p>
       Thank you for choosing Youtube Thumbnail Downloader as your platform for downloading YouTube video thumbnails. Start exploring, downloading, and enhancing your creative works today!
       </p>
    </div>
  );
};
